  ...
  return (
    <motion.div ref={ref}
      ...
      <div className='flex flex-col gap-2 lg:gap-6 items-center'>
        ...
        <NavLink to="/" className='font-medium text-2xl lg:text-4xl text-center md:w-[80%]'>{heading}</NavLink>

        <NavLink to="/" className="text-sm border-b-[1px] border-dark mt-4 md:mt-0 font-light">Read more</NavLink>
      </div>
    </motion.div>
  )
}
